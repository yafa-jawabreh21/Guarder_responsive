function Home () {
    return(
        ...
        <div className="bg-cover bg-no-repeat bg-[url('https://img.freepik.com/free-photo/portrait-male-security-guard-with-radio-station_23-2150368765.jpg?w=1060&t=st=1729344618~exp=1729345218~hmac=2e4e5cfafcd172681dbec1ddbd7275a5977b2890efb10625b0b2d7edc572f260')]" >
        <nav class="bg-white border-gray-200 dark:bg-gray-900 pl-10 ">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:hover:bg-black md:bg-opacity-80 md:p-3 dark:text-white md:dark:text-blue-500" aria-current="page">Home</a>
        </li>
        <li>
