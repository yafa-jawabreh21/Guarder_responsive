...
import Quards from "./components/Guards";
function Home () {
    return(
        <>
        

        <div className="bg-cover bg-no-repeat bg-[url('https://images.pexels.com/photos/7715091/pexels-photo-7715091.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')]" >
    ...
    <div class="hidden w-full md:block md:w-auto md:pr-36" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li className="md:hover:bg-black md:hover:rounded-sm">
          <a href="#section1" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:bg-black md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ">About</a>
        </li>
        <li className="md:hover:bg-black md:hover:rounded-sm">
          <a href="#section2" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:bg-black md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
        </li>
        <li className="md:hover:bg-black md:hover:rounded-sm">
          <a href="#section3" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:bg-black md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Quarder</a>
        </li>
        <li className="md:hover:bg-black md:hover:rounded-sm">
          <a href="#section4" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:bg-black md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact Us</a>
        </li>
      </ul>
    </div>
  </div>
